...
#[test]
fn driver_type_kmdf() {
    test_project_creation("kmdf");
}

#[test]
fn driver_type_umdf() {
    test_project_creation("umdf");
}

#[test]
fn driver_type_wdm() {
    test_project_creation("wdm");
}

#[test]
fn no_driver_type() {
    test_invocation(&[], true, false, |stdout, stderr| {
...
#[test]
fn multiple_driver_types() {
    test_invocation(&["--kmdf", "--umdf"], true, false, |stdout, stderr| {
        assert!(stdout.is_empty());
...
fn missing_required_arguments() {
    test_invocation(&[], false, false, |stdout, stderr| {
        assert!(stdout.is_empty());
        assert!(stderr.contains("error: the following required arguments were not provided:"));
        assert!(stderr.contains("<--kmdf|--umdf|--wdm>"));
...
#[test]
fn help() {
    test_invocation(&["--help"], false, true, |stdout, stderr| {
...
fn test_project_creation(driver_type: &str) {
    with_file_lock(|| {
