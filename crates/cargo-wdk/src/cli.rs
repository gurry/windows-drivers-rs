...
mod tests {
    ...
    #[test]
    pub fn arch_detection_supported_toolchains() {
    ...
    #[test]
    pub fn arch_detection_unsupported_toolchains() {
    ...
    #[test]
    pub fn arch_detection_rustc_command_fails() {
        let result =
    ...
    fn new_args_driver_type_no_selection() {
        let args = NewArgs {
            kmdf: false,
            umdf: false,
            wdm: false,
    ...
    fn new_args_driver_type_multiple_selections() {
        let args = NewArgs {
            kmdf: true,
            umdf: true,
            wdm: false,
